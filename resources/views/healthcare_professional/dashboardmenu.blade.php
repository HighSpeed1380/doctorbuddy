...
<ul>
    <li class="overview p5">
        <div class="text-center bg ">
            <?php if($loginedHp->healthcare_professional_image != ''){ ?>
                <img src="{{ asset('uploads/healthcare_professional/icon/'.$loginedHp->healthcare_professional_image);?>"  alt="image">
            <?php } else { ?>
                <img src="{{ asset('images/provider.png')?>"  alt="image">
            <?php } ?>
    ...
    <li class="notifications <?php echo $reviews ?>">
        <a href="{{ asset('healthcare_professional/reviews')?>"> Customer Reviews</a>
    </li>    
