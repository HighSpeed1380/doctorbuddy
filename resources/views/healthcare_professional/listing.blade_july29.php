    ...
    <div class="row">
        <?php foreach ($hpObjects as $hpObject) : ?>
            ...
            <div class="hp-listing-outer text-center">
                ...
                <a href="{{ asset('healthcare_professional/details/'.$hpObject->healthcare_professional_id) ?>">
                <?php if(isset($hpObject->healthcare_professional_image) && $hpObject->healthcare_professional_image !='') : ?>
                    <img src="{{ asset("uploads/healthcare_professional/thumbnail")."/".$hpObject->healthcare_professional_image ?>" width="80" height="80">
                <?php else: ?>
                    <img src="{{ asset("public/images")."/user.png"?>" width="80" height="80"> 
                <?php endif ;?>
...
<script src="{{ asset('js/healthcare_professional/search_hp.js'); ?>"></script>
@stop