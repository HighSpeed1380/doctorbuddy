                     ...
                     <div class="col-lg-12">
                                 ...
                                 <div class="col-lg-6">
                                     <div id="pdfdv_<?php echo $printId ?>" class="col-lg-3 text-left">
                                         <a href="{{ asset('pdfreports/'.$report['customer_fileno']);?>.pdf" target="_blank">
                     ...
                     <div class="col-lg-12  list-casefile ">
                         ...
                         <div class="col-lg-7 ">
                             <label class=""> 
                                 ...
                                 <strong>
                                     <a href="{{ asset("uploads/files/".$report['customer_medicalreport']);?>">
                                         Download 
                                     </a>    
                                 </strong>
                                 <?php endif;?>
...
<script src="{{ asset('js/healthcare_professional/case_report.js'); ?>"></script>
