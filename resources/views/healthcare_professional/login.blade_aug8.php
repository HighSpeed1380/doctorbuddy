...
<form class="m-t" role="form" action="javascript:void(0);"  id="loginform">
    ...
    <div class="form-group">
      ...
      <a href="{{ asset('healthcare_professional/forgotpassword'); ?>"><small>Forgot password?</small></a>
    </div>
    <p class="text-muted text-center"><small>Do not have an account?<a  href="{{ asset('healthcare_professional/register'); ?>">Create an account</a></small></p>
...
<script src="{{ asset('js/healthcare_professional/login.js'); ?>"></script>
@stop
