                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12 no-pad m-t-lg">
                        ...
                        <div class="form-group col-lg-12 no-pad"> 
                          ...
                          <div class="col-lg-5 col-sm-5 col-xs-5">                              
                                ...
                                <div id="waiting_div" class="hide"><img src="{{ asset('images/loading.gif') ?>"  width="40" height="40"></div>
...
<!--                        <input type="image" src="{{ asset('images/go-btn.png') ?>" onclick="getqn('0','1')">-->
                       ...
                       <a href="javascript:void(0);" onclick="getqn('0','1')"><img src="{{ asset('images/go-btn.png') ?>"></a>
                    ...
                    <p class="sub-mit col-lg-12  col-sm-12 col-xs-12 no-pad m-t">
                        ...
                        <a href="javascript:void(0);" onclick="getqn('0','f')"><img src="{{ asset('images/go-btn.png') ?>"></a>
                    ...
                    <p class="col-lg-12 col-sm-12 col-xs-12 no-pad info-i">
                        ...
                        <i><img alt="info-icon" src="{{ asset('images/info-icon.png') ?>"></i><span>* Once you finish the questions, our specialists will be responding to your issues.
...
<script src="{{ asset('js/questionjs.js'); ?>"></script>
