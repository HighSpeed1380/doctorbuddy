...
<!--                    <a class="reset_pass" href="#">Lost your password?</a>-->
    ...
    <div class="frm-lgroup">
             ...
             <div class="item col-md-6 col-sm-6 col-xs-12 text-right">
                 <a href="{{ asset('index.php/home/forgotpassword'); ?>">Forgot Password</a>
             </div></div>
    </form>
            ...
            success: function(data) { 
                if(data.id>0){
                    if(data.verify==1){
                        ...
                        $("#loginform").submit();
//                        window.location.href = '{{ asset('index.php/home/finish'); ?>/'+data.id;
                    }else{
                        $('#nm').show();
...
{    
         ...
         $.ajax({
            type: "GET",
            url: "{{ asset('index.php/home/verifysend'); ?>/"+id,
            data: {id: id},
            success: function(data) { 
                $('#nm').html(data);
            }
