...
<!--                <a href="javascript:void(0);" onclick="return home_sumit();"><img src="{{ asset('images/go-btn.png') ?>"></a>-->

                <input type="image" src="{{ asset('images/go-btn.png') ?>" onclick="return home_sumit();">
...
<script src="{{ asset('js/questions/home.js'); ?>"></script>
