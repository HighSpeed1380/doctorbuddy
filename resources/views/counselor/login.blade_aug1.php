...
<div class="text-center" id="login-wrap">
    ...
    <form class="m-t" role="form" action="javascript:void(0);"  id="loginform">
                ...
                <a href="{{ asset('counselor/forgotpassword'); ?>"><small>Forgot password?</small></a>
                <p class="text-muted text-center">
                <small>Do not have an account?
                <a  href="{{ asset('counselor/register'); ?>">Create an account</a>
                </small>
                </p>
            </form>
...
<script src="{{ asset('js/counselor/login.js'); ?>"></script>
@stop