...
$(function(){
  $("body").on("keyup", "#symptom", function(){
    ...
    $.ajax({
        type: "GET",
        url: "{{ asset('index.php/home/loadsymptom'); ?>",
...
$("body").on("change", "#country", function(){
    ...
    $.ajax({
            type: "GET",
            url: "{{ asset('index.php/home/state'); ?>",
            data: {cnty: cnty},
            success: function(data) {    
                if(data!=''){
                    $('#stated').hide();    
...
{ 
    ...
    if($('#nick_name').val() == '')
    {
        ...
        var nick = $('#nick_name').val();
         $.ajax({
            type: "GET",
            url: "{{ asset('index.php/home/nickcheck'); ?>",
            data: {nick: nick},
            success: function(data) {    
                if(data == 1){
                    getqn('0');  
    ...
    if (!validator.checkAll($('form'))) {   
        ...
        if(document.qform.existing['0'].checked==false){
            ...
            var pwd = $('#user_password').val();
             $.ajax({
                type: "GET",
                url: "{{ asset('index.php/home/usercheck'); ?>",
                data: {user: user,pwd: pwd},
                success: function(data) {    
                    if(data.id>0){
                        $('#nm').hide();
                        $('#em').hide();
                        var action = "{{ asset('index.php/home/finish'); ?>";
            ...
            $.ajax({
               type: "GET",
               url: "{{ asset('index.php/home/userexist'); ?>",
               data: {user: user},
               success: function(data) {   
                   if(data ==0){
                        $('#exister').hide();
...
//                $('#ercntry').hide();    
    ...
    if (!validator.checkAll($('form'))) {   
        ...
        if(id >= 0 || id=='f'){
            ...
            $.ajax({
                type: "POST",
                url: "{{ asset('index.php/home/loadqn'); ?>",
