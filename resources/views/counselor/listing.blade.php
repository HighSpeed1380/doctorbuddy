    ...
    <div class="row">
        <?php foreach ($counselorObjects as $counselorObject) : ?>
            ...
            <div class="hp-listing-outer text-center">
                ...
                <a href="{{ asset('counselor/details/'.$counselorObject->counselors_id) ?>">
                    <?php if(isset($counselorObject->counselors_photo) && $counselorObject->counselors_photo !='') : ?>
                        <img src="{{ asset("uploads/counselor/thumbnail")."/".$counselorObject->counselors_photo ?>" width="80" height="80">
                    <?php else: ?>
