...
<head>
  ...
  <link href="{{ asset('css/style_video.css'); ?>" rel="stylesheet">
  <link href="{{ asset('css/fancy_video.css'); ?>" rel="stylesheet" type="text/css">
  
  <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8/jquery.min.js"></script>
  <script type="text/javascript" src="{{ asset('js/peer.js'); ?>"></script>
  <script>
    // Compatibility shim
