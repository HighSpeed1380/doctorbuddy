                ...
                <div class="col-lg-12 col-sm-12 col-xs-12">
                    ...
                    <div class=" col-lg-3 col-sm-3 col-xs-12 text-center p-block">
                        <?php if(isset($hpObject->healthcare_professional_image) && $hpObject->healthcare_professional_image !='') : ?>
                            <img src="{{ asset("uploads/healthcare_professional/thumbnail")."/".$hpObject->healthcare_professional_image ?>"  class="img-circle circle-border m-b-md" alt="profile">
                        <?php else: ?>
  ...
  <abbr title="Phone">Email:</abbr> <?php echo $hpObject->healthcare_professional_email_address ?>  
                    ...
                    <div class="form-group">
                            <div class="col-md-12 col-sm-12 col-xs-12 col-md-offset-3">
                                <a href="{{ asset('admin/healthcareprofessional')?>">
                                    <button type="button" class="btn btn-primary">Back</button>
                                </a>
                                <a href="{{ asset('admin/casefiles/hp/'.$hpObject->healthcare_professional_id)?>">
