                      ...
                      <div class="reportdv">
                                  ...
                                  <div class="reportdv">
                                      <label class="control-rpt col-md-12 col-sm-3 col-xs-12" for="last-name">Customer Answers: 
                                          <a href="{{ asset('./admin/report/'.$data[$id]['detail_id']);?>" ><button type="button" class="btn btn-primary">View</button></a>
                                            </label>
...
//                                            $file_name = $report->filepath;
                                        ...
                                        ?>
                                        <a href="{{ asset('../pdfreports/'.$file_name);?>" target="_blank"><button type="button" class="btn btn-primary">PDF</button></a>
                                         </label>
                                            </div>
