                            ...
                            ?>
                                ...
                                <tr class="even pointer">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ asset('admin/approve-counselor/'.$counselor->counselors_id)?>" onclick="return confirm('Are you sure to approve this Counselor?')">
                                    ...
                                    <td>
                                       <a href="{{ asset('admin/viewcounselor/'.$counselor->counselors_id)?>">
                                            <i class="fa fa-eye fa-4" aria-hidden="true" title="Customer Details"></i>
                                       </a>
                                       &nbsp; 
                                        <a href="{{ asset('admin/counselor/edit/'.$counselor->counselors_id)?>">
