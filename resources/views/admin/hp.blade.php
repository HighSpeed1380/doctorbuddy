...
<!--                                     <td class=" ">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ asset('admin/approve-hp/'.$healthcareprofessional->healthcare_professional_id)?>" onclick="return confirm('Are you sure to approve this Healthcare Professional?')">
                                    ...
                                    <td>
                                        <a href="{{ asset('admin/healthcareprofessional/view/'.$healthcareprofessional->healthcare_professional_id)?>">
                                           <i class="fa fa-eye fa-4" aria-hidden="true" title="Healthcare Details"></i>
                                        </a>
                                        &nbsp;                                       
                                        <a href="{{ asset('admin/templates/particular_provider/'.$healthcareprofessional->healthcare_professional_id)?>">
                                            <i class="fa fa-sliders fa-4" aria-hidden="true" title="Templates"></i>
                                        </a>
                                       &nbsp;                                         
                                        <a href="{{ asset('admin/healthcareprofessional/edit/'.$healthcareprofessional->healthcare_professional_id)?>">
                                            <i aria-hidden="true" class="fa fa-pencil fa-4" title="Edit"></i>
                                        </a> 
                                       &nbsp;                                         
                                        <a href="{{ asset('admin/casefiles/hp/'.$healthcareprofessional->healthcare_professional_id)?>">
