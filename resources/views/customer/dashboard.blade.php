...
//                                       $counArr[] = $name;
                            ...
                            <td class="links">
                                ...
                                <a href="{{ asset('customer/reports/'.$customerinfo->customer_detail_id );?>" >   
                                    <i aria-hidden="true" class="fa fa-file-excel-o fa-4" title="View Case File"></i>
                                </a>
                                &nbsp;
                                <a href="{{ asset('customer/symptom/'.$customerinfo->customer_detail_id );?>" >
                                    <i class="fa fa-sliders fa-4" aria-hidden="true" title="Symptoms"></i>
                                </a>
                               &nbsp;
                                <a href="{{ asset('customer/uploadfiles/'.$customerinfo->customer_detail_id );?>" >
                                    <i class="fa fa-upload fa-4" aria-hidden="true" title="Upload Documents"></i>
                                </a>
                                &nbsp;
                                <a href="{{ asset('customer/assignedproviders/'.$customerinfo->customer_detail_id );?>" >
