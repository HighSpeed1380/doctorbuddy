...
<div  id="login-wrap" class="text-center">
    ...
    <form class="m-t" role="form" action="javascript:void(0);"  id="loginform">
        ...
        <p class="text-muted text-center"><a href="{{ asset('customer/forgotpassword'); ?>">Forgot password?</a></p>
        <p class="text-muted text-center">Do not have an account?<a href="{{ asset('customer/register'); ?>"> Create an account</a></p>
