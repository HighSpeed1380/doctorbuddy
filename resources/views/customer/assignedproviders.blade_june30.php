                ...
                <?php if(count($caseFileToHPObjs) >0) { ?>
                    <?php foreach($caseFileToHPObjs as $caseFileToHPObj){  ?>
                        ...
                        <tr>
                            ...
                            <td> 
                                <?php $hpName = ucfirst($caseFileToHPObj->healthcare_professional_first_name)." ".$caseFileToHPObj->healthcare_professional_last_name ?>   
                                    ...
                                    <?php if($caseFileToHPObj->healthcare_professional_first_name != ''): ?>
                                        <a href='{{ asset("healthcare_professional/details/$hpId") ?>'><?php echo $hpName ?></a>
                                    <?php else: ?>
                            ...
                            <td class="links">
                                <a href="{{ asset("customer/conversations/$customerDetilId/$hpId") ?>">Conversations</a>
                                <?php 
                                ...
                                <a href='{{ asset("customer/payment/$encodedCasefileToHPId") ?>'>
                                <img src="{{ asset('images/paynow.png'); ?>">
                                </a>
                                <?php } ?> 
                            </td>
                        </tr>
