                ...
                <?php if(isset($data['reviewinfo'])&& count($data['reviewinfo']) > 0){ ?>
                    <?php foreach($data['reviewinfo'] as $reviewinfo){ ?>
                        ...
                        <tr>
                            ...
                            <td class="links">
                                <a href="{{ asset('customer/reviews/edit/'.$reviewinfo->review_id );?>" >   
                                    <i aria-hidden="true" class="fa fa-pencil fa-4" title="Edit Review"></i>
                                </a>&nbsp;
                                <a href="{{ asset('customer/reviews/delete/'.$reviewinfo->review_id );?>" onclick="return confirm('Are you sure to delete this Review?')">   
