...
<div class="container">
    ...
    <div class="social col-lg-4 pull-right text-right">
        <a href="javascript:void(0);"><img src="{{ asset('images/facebook-icon.png'); ?>" alt="Facebook"></a>
        <a href="javascript:void(0);"><img src="{{ asset('images/tweet.png'); ?>" alt="Twitter"></a>
        <a href="javascript:void(0);"><img src="{{ asset('images/gplus-icon.png'); ?>" alt="gplus"></a>
    </div>
