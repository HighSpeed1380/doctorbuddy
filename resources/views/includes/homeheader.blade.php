...
<!--                    <span class="login"><a href="customer/login">Login</a></span>-->
             <!--   <a href="https://www.facebook.com/doctorbuddycom-1727232294191495/?fref=ts" target="_blank"><img src="{{ asset('images/facebook-icon.png'); ?>" alt="Facebook"></a> -->
                <a href="https://www.facebook.com/Doctorbuddy-324523137891748" target="_blank"><img src="{{ asset('images/facebook-icon.png'); ?>" alt="Facebook"></a>

                <a href="https://twitter.com/doctorbuddy1" target="_blank"><img src="{{ asset('images/tweet.png'); ?>" alt="Twitter"></a>
                <a href="#"><img src="{{ asset('images/gplus-icon.png'); ?>" alt="gplus"></a>
                </div>
             <a class="navbar-brand hidden-xs" href="{{ asset(''); ?>"><img src="{{ asset('images/logo.png'); ?>" class="img-responsive"></a>
            <a class="navbar-brand hidden-sm hidden-md hidden-lg" href="{{ asset(''); ?>"><img src="{{ asset('images/logo-xs.png'); ?>" class="img-responsive"></a>
     ...
     ?>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right topnav"> 
                    ...
                    <li><a href="{{ asset('home/basic'); ?>">Start New Case File</a></li>
                    ...
                    <?php endif ;?>
                     ...
                     <?php if($customerId != '' ){ ?>
                        <li><a href="{{ asset('customer/dashboard'); ?>"  >Dashboard</a></li> 
                     <?php } else if ($hpId != '') { ?>
                        <li><a href="{{ asset('healthcare_professional/dashboard'); ?>"  >Dashboard</a></li> 
                     <?php } else if ($counselorId != '') { ?>  
                        <li><a href="{{ asset('counselor/dashboard'); ?>"  >Dashboard</a></li>
                     <?php } ?>   
                    ...
                    <?php if($userLogined): ?>
                        <li><a href="{{ asset('home/logout'); ?>">Logout</a></li>
                    <?php endif ; ?>        
