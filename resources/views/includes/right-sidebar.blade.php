...
<a href="{{ asset('healthcare_professional/details/'.$val['healthcare_professional_id'])?>">
    <div class="col-sm-2 col-xs-4 col-md-4">
        <div class="text-center">
            <?php if ($val['photo'] !='') : ?>
                <img src="{{ asset('uploads/healthcare_professional/thumbnail/'.$val['photo']);?>" class="m-t-xs img-responsive" alt="image">
            <?php else : ?>
                <img src="{{ asset('images/no_image.png');?>" class="m-t-xs img-responsive" alt="image">
            <?php endif ;?>
