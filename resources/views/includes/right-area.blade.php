...
<div class="col-lg-6 col-sm-12  col-xs-12 left common-right-area">
    ...
    <div class="col-lg-6 col-sm-12 col-xs-12 no-pad counselor-box left">
            <div class="col-lg-12 title-box cousi-box">
                <h3><a href="{{ asset('counselor/listing')?>">Our Counselors</a></h3>
...
the best support!</p>
            ...
            foreach($counselors as $counselor){  
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12 text-center">
                    <a href="{{ asset('counselor/details').'/'.$counselor->counselors_id ?>">
                    <?php if ($counselor->counselors_photo !='') : ?>
                        <img src="{{ asset('uploads/counselor/icon/'.$counselor->counselors_photo);?>" class="img-circle m-t-xs img-responsive" alt="image" width="68" height="68">
                    <?php else : ?>
                        <img src="{{ asset('images/c1.png')?>" class="img-circle m-t-xs img-responsive" alt="image">
                    <?php endif ;?> 
                    </a>    
                </div>
                ...
                <div class="textcenter">
                    <p class="name">
                        <a href="{{ asset('counselor/details').'/'.$counselor->counselors_id ?>"><?php echo ucwords(strtolower(implode(" ",$nameArr))) ?></a>
                    </p>
...
<!--                    <p class="chat-icon">
    ...
    <div class="col-lg-6 col-sm-12 col-xs-12 no-pad provider-box left">
        <div class="col-lg-12 title-box provi-box">
            <h3><a href="{{ asset('healthcare_professional/listing')?>">Our Providers</a></h3>
        ...
        ?>
            ...
            <div class="col-lg-4 col-sm-4 col-xs-12 text-center">
                <a href="{{ asset('healthcare_professional/details').'/'.$healthcare_professional->healthcare_professional_id ?>">
                <?php if ($healthcare_professional->healthcare_professional_image !='') : ?>
                <img src="{{ asset('uploads/healthcare_professional/icon/'.$healthcare_professional->healthcare_professional_image);?>" class="img-circle m-t-xs img-responsive" alt="image" width="68" height="68">
            <?php else : ?>
                <img src="{{ asset('images/c1.png')?>" class="img-circle m-t-xs img-responsive" alt="image">
            <?php endif ;?>
...
<!--                <img src="<?php //echo asset('images/plogo1.png')?>" alt="provider-logo">-->
                <p class="name">
                    <a href="{{ asset('healthcare_professional/details').'/'.$healthcare_professional->healthcare_professional_id ?>"><?php echo ucwords(strtolower(implode(" ",$nameArr))) ?></a>
                </p>
